    ...
    <header className="sticky top-0 z-40 border-b border-slate-200/80 bg-white/95 backdrop-blur">
      <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-3 sm:px-6 lg:px-8">
        ...
        <nav className="hidden items-center gap-1 text-sm text-slate-600 md:flex">
          <Link href="/#categories" className="rounded-lg px-3 py-2 transition hover:bg-slate-100 hover:text-slate-900">
            Home
          </Link>
          ...
          <div className="relative" onMouseEnter={() => setCategoriesOpen(true)} onMouseLeave={() => setCategoriesOpen(false)}>
            ...
            {categoriesOpen && (
              <div className="absolute left-0 top-full z-50 mt-1 w-64 rounded-2xl border border-slate-200 bg-white p-2 shadow-xl">
          ...
          <Link href="/categories/financial" className="rounded-lg px-3 py-2 transition hover:bg-slate-100 hover:text-slate-900">
            Financial
          </Link>
          <Link href="/categories/math" className="rounded-lg px-3 py-2 transition hover:bg-slate-100 hover:text-slate-900">
            Math
          </Link>
          <Link href="/about" className="rounded-lg px-3 py-2 transition hover:bg-slate-100 hover:text-slate-900">
            About
          </Link>
        </nav>
