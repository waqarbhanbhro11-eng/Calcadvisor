// Human-written content overrides for Financial calculators
// These replace the auto-generated AI content with genuine, helpful text
...
export const financialContentOverrides: Record<string, ContentOverride> = {
  ...
  "budget-planner": {
    ...
    faqs: [
      {
        question: "Should I use my gross salary or net (take-home) pay?",
        answer: "Always use your net take-home pay — the amount deposited after taxes and deductions. Using your gross salary will give you an inflated budget that doesn't reflect reality.",
      },
      {
        question: "What counts as a 'Housing' expense?",
        answer: "Housing includes rent or mortgage payments, renter's or homeowner's insurance, and property taxes if you pay them monthly. Don't include utilities here — that has its own field.",
      },
      {
        question: "My budget shows a deficit — what should I do?",
        answer: "First, check if any expenses are overestimated. If the numbers are accurate, look at your largest variable expenses (dining, shopping, subscriptions) — those are usually the easiest to reduce quickly.",
      },
      {
        question: "How often should I run this calculator?",
        answer: "Ideally once a month, or whenever your income or major expenses change. A budget that was accurate in January might be completely wrong by July if your rent went up or you changed jobs.",
      },
    ],
  },
    ...
    faqs: [
      {
        ...
        answer: "Yes, but be realistic about its value. Use a site like Kelley Blue Book to check the current private-party sale value. Cars depreciate quickly, so this number may be lower than you expect.",
      },
      {
        question: "What is a good net worth for my age?",
        answer: "A common benchmark is to have a net worth equal to your annual salary by age 30, three times your salary by 40, and six times by 50. But these are rough averages — your circumstances matter more than any benchmark.",
      },
      {
        question: "How often should I calculate my net worth?",
        answer: "Once every three to six months is enough for most people. Checking too frequently can cause unnecessary stress from short-term market swings, especially if you have investments.",
      },
    ],
  },
    ...
    faqs: [
      {
        ...
        answer: "Build a small emergency fund first — $1,000 to $2,000 — then focus on high-interest debt, then build the full emergency fund. Without any buffer, one unexpected expense will put you right back into debt.",
      },
      {
        question: "Can I invest my emergency fund to earn more?",
        answer: "No. Emergency funds should be in cash or a high-yield savings account — never invested in stocks or bonds. You might need it on a day the market is down 20%, and you can't afford to wait for it to recover.",
      },
      {
        question: "Does my emergency fund need to cover my full rent?",
        answer: "Yes. Include all essential fixed expenses — rent or mortgage, utilities, minimum loan payments, groceries, and insurance. These are the bills that don't stop just because your income does.",
      },
    ],
  },
  ...
  "cash-flow": {
    ...
    faqs: [
      {
        question: "What's the difference between cash flow and net worth?",
        answer: "Cash flow is what happens each month — income versus spending. Net worth is the cumulative result over years. Good cash flow builds net worth over time; negative cash flow erodes it.",
      },
      {
        question: "Should I include irregular income like bonuses?",
        answer: "For your baseline cash flow, use only regular reliable income. Treat bonuses and irregular income as a bonus when they arrive — don't build your monthly budget around them.",
      },
      {
        question: "How do I improve negative cash flow quickly?",
        answer: "Variable expenses are your fastest lever. Review streaming subscriptions, dining out, and impulse purchases first — these can often be cut by $200 to $400 a month without significantly affecting quality of life.",
      },
    ],
  },
  ...
  "savings-goal": {
    ...
    faqs: [
      {
        question: "What if I can't contribute the same amount every month?",
        answer: "Use a conservative average. If some months you can save $400 and others $800, entering $450 gives you a realistic timeline without assuming your best-case months happen consistently.",
      },
      {
        question: "Should I use the APY or APR from my savings account?",
        answer: "Use the APY (Annual Percentage Yield) — it already accounts for compounding. It's usually labeled clearly on your bank's savings account page.",
      },
      {
        question: "What's the best account for a savings goal with a timeline under two years?",
        answer: "A high-yield savings account or a money market account works well for short to medium timelines. CDs can offer slightly higher rates but lock your money up for a fixed period — only use them if you won't need the money early.",
      },
    ],
  },
    ...
    faqs: [
      {
        ...
        answer: "For long-term planning, 3% is a reasonable US historical average. For near-term projections, check the current CPI figure from the Bureau of Labor Statistics. If you're planning for retirement decades away, 3–4% is a conservative assumption.",
      },
      {
        question: "How do I protect my savings from inflation?",
        answer: "Keep only your emergency fund in cash. Everything else should be invested in assets that historically outpace inflation — diversified stock index funds, I-bonds, real estate, or TIPS (Treasury Inflation-Protected Securities).",
      },
      {
        question: "Does this calculator account for compound inflation?",
        answer: "Yes. It uses compound inflation, which means each year's increase applies to the already-inflated price from the year before. This is how inflation actually works and why the long-term effect is so significant.",
      },
    ],
  },
    ...
    faqs: [
      {
        ...
        answer: "For long-term stock market investing, 7–8% after fees is a commonly used conservative assumption. For bonds, 3–4%. For a mixed portfolio, 5–6%. Always use rates net of fees — a 1% annual expense ratio has a larger long-term impact than most people expect.",
      },
      {
        question: "Does this assume monthly or annual compounding?",
        answer: "This calculator uses monthly compounding, which is standard for most investment and savings accounts. It produces slightly better results than annual compounding over long periods.",
      },
      {
        question: "Should I factor in taxes on returns?",
        answer: "If the investments are in a tax-advantaged account like a 401(k) or Roth IRA, taxes on growth are deferred or eliminated. For taxable accounts, reduce your expected return by roughly 0.5–1% to account for annual capital gains distributions.",
      },
    ],
  },
  ...
  "expense-split": {
    ...
    faqs: [
      {
        question: "How do I split unevenly — like if one person owes more?",
        answer: "This calculator handles equal splits only. For uneven splits, divide the total by the total number of shares and multiply by each person's share count. For example, if person A owes 2 parts and person B owes 1 part of a $90 bill: each part is $30, so A pays $60 and B pays $30.",
      },
      {
        question: "Should we split before or after tip at a restaurant?",
        answer: "Splitting after tip is cleaner — calculate the tip on the full bill first, then divide the total (bill plus tip) by the number of people. This avoids separate tip calculations.",
      },
    ],
  },
  ...
  "commission": {
    ...
    faqs: [
      {
        question: "Is commission taxed differently from a salary?",
        answer: "Commission is taxed as ordinary income, just like your salary. However, if your employer withholds a flat 22% on commission checks (which is common), you may owe more or less than that depending on your actual tax bracket and deductions.",
      },
      {
        question: "What's a typical commission rate by industry?",
        answer: "Real estate agents typically earn 2.5–3% of the sale price. Software sales roles often see 8–12% of contract value. Retail varies widely, usually 3–10%. Insurance agents can see anywhere from 5–40% depending on the product and carrier.",
      },
    ],
  },
  ...
  "salary-to-hourly": {
    ...
    faqs: [
      {
        question: "Should I use gross or net salary for this calculation?",
        answer: "This calculator uses gross salary by default, which is the standard for salary comparisons. If you want to know your true take-home hourly rate, you can enter your net annual income instead.",
      },
      {
        question: "How many working weeks are in a year?",
        answer: "The US has 10 federal holidays and most full-time employees receive 10–15 vacation days, putting typical working weeks between 48 and 50. Two weeks off = 50 working weeks; three weeks off = 49; four weeks off = 48.",
      },
      {
        question: "Does this account for unpaid overtime?",
        answer: "Salaried exempt employees in the US aren't entitled to overtime pay regardless of hours worked. If you regularly work over 40 hours with no additional compensation, enter your actual hours into the calculator — the resulting hourly rate will reflect what you're truly earning per hour.",
      },
    ],
  },
    ...
    faqs: [
      {
        ...
        answer: "Not automatically. If you regularly work overtime at a higher rate, calculate your regular and overtime earnings separately, then add them together for a total annual figure.",
      },
      {
        question: "Should I include tips or bonuses in my hourly rate?",
        answer: "For a complete picture of your income, yes. Add your average annual tips or bonuses to the calculator's annual result. For loan applications and tax purposes, tips are counted as income.",
      },
    ],
  },
    ...
    faqs: [
      {
        ...
        answer: "In taxable accounts, yes — reinvested dividends are taxed as income in the year received, even though you didn't take the cash. This is a key reason why holding dividend stocks in tax-advantaged accounts like IRAs and 401(k)s can be more efficient.",
      },
      {
        question: "What's a realistic dividend yield for a DRIP?",
        answer: "Broad market index funds yield around 1.3–1.5% in dividends. Dividend-focused funds like VYM or SCHD yield 3–4%. Individual dividend stocks can yield 5–8%, though higher yields often come with more risk. Total return matters more than yield alone.",
      },
      {
        question: "Can I do a DRIP with ETFs, or only individual stocks?",
        answer: "Most brokerages allow automatic reinvestment with both ETFs and individual stocks. Check your brokerage's settings — it's usually a simple toggle per holding.",
      },
    ],
  },
  ...
  "break-even": {
    ...
    faqs: [
      {
        question: "What if I sell multiple products with different margins?",
        answer: "For a multi-product business, use a weighted average contribution margin. Multiply each product's contribution margin by its percentage of total sales, add the results, and use that blended margin in the formula.",
      },
      {
        question: "How do I use this for a service business with no physical units?",
        answer: "Define 'units' as hours of service, client contracts, or projects. If you charge $150/hour and each hour costs you $40 in direct costs (your time, software, etc.), your contribution margin per hour is $110. Divide fixed costs by $110 to find the hours needed to break even.",
      },
      {
        question: "Does break-even include the owner's salary?",
        answer: "It depends on whether you pay yourself a fixed salary or take distributions. If you pay yourself a fixed salary, include it in fixed costs. If you take profits as distributions, it won't appear in the break-even calculation — reaching break-even means covering business costs, not your personal income.",
      },
    ],
  },
    ...
    faqs: [
      {
        ...
        answer: "It depends entirely on context and time horizon. For stocks, the long-term historical average is roughly 10% annually. For real estate, 8–12% is typical. For a business investment expected to pay back in one year, 20%+ is usually the minimum threshold. For comparison, a savings account might earn 4–5% ROI annually with zero risk.",
      },
      {
        question: "How do I calculate ROI for a rental property?",
        answer: "Use annual net rental income (rent minus all expenses: mortgage, tax, insurance, maintenance, vacancy) as the gain, and your total cash invested (down payment plus closing costs plus any renovation costs) as the cost. This gives you your cash-on-cash ROI.",
      },
      {
        question: "Does ROI account for inflation?",
        answer: "Standard ROI calculations don't adjust for inflation. To find your real ROI, subtract the inflation rate from your nominal ROI percentage. During a period of 3.5% inflation, a 7% ROI investment is only providing 3.5% real returns.",
      },
    ],
  },
  ...
  "monthly-spending": {
    ...
    faqs: [
      {
        question: "How accurate do my numbers need to be?",
        answer: "Rough estimates work for a first pass — the goal is to see your spending in categories, not to account for every dollar. If you want precision, pull your last three months of bank and credit card statements and calculate the actual average.",
      },
      {
        question: "What falls under 'Other expenses'?",
        answer: "Anything that doesn't fit the main categories: personal care (haircuts, toiletries), pets, gifts, clothing, home supplies, subscriptions, and miscellaneous purchases. Most people are surprised how quickly this category totals up.",
      },
      {
        question: "How should I handle irregular expenses like car repairs or vacations?",
        answer: "Divide the expected annual cost by 12 and enter that monthly average. For example, if you spend roughly $1,200/year on car maintenance, enter $100/month. This gives you a more realistic monthly picture than ignoring irregular costs entirely.",
      },
    ],
  },
  ...
  "purchase-affordability": {
    ...
    faqs: [
      {
        question: "How much of my income should a car payment be?",
        answer: "Most financial advisors recommend keeping total car costs — payment, insurance, fuel, and maintenance — under 15–20% of your monthly take-home pay. The payment alone shouldn't exceed 10–12%.",
      },
      {
        question: "Should I drain my savings to make a bigger down payment?",
        answer: "No. Keep your emergency fund intact. A larger down payment is helpful, but not at the cost of leaving yourself financially vulnerable. The right balance is to put down enough to get reasonable loan terms while keeping 3–6 months of expenses in reserve.",
      },
    ],
  },
  ...
  "subscription-cost": {
    ...
    faqs: [
      {
        question: "What annual price increase should I expect?",
        answer: "Most major subscription services have raised prices 5–10% annually over the past decade. Using 5% is a conservative but realistic assumption for planning purposes.",
      },
      {
        question: "How do I audit all my current subscriptions?",
        answer: "Check your credit card and bank statements for recurring charges, then check your PayPal or Apple/Google Pay accounts for anything billed there. Look at the past 90 days. Most people find at least one subscription they'd forgotten about.",
      },
      {
        question: "Is it ever worth paying annually instead of monthly?",
        answer: "Usually yes — most services offer 15–25% off for annual billing. If you're confident you'll use the service for at least 10 months, paying annually almost always saves money. Calculate the monthly equivalent of the annual price and compare it to the monthly rate.",
      },
    ],
  },
